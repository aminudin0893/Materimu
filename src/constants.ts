...
export const initialData = {
  ...
  atpTabel: [
    { tahap: "Pendahuluan", kegiatan: "1. Guru membuka pelajaran dengan salam dan doa bersama.\n2. Melakukan presensi dan menyiapkan kondisi fisik/psikis siswa.\n3. Apersepsi: Guru memberikan pertanyaan pemantik tentang pengalaman berpuasa.\n4. Menyampaikan Tujuan Pembelajaran dan garis besar langkah kegiatan.", durasi: "15 Menit" },
    { tahap: "Kegiatan Inti", kegiatan: "1. Orientasi Masalah: Siswa menyimak pemaparan pengertian dan dalil puasa.\n2. Mengorganisasikan Siswa: Guru membagi siswa ke dalam beberapa kelompok diskusi.\n3. Membimbing Penyelidikan: Siswa membedah materi syarat, rukun, dan pembatal puasa serta mengerjakan LKPD.\n4. Menyajikan Hasil: Setiap kelompok mempresentasikan hasil diskusi studi kasus di depan kelas.\n5. Evaluasi: Kelompok lain memberikan tanggapan dan guru memberikan penguatan konsep.", durasi: "90 Menit" },
    { tahap: "Penutup", kegiatan: "1. Guru dan peserta didik membuat kesimpulan bersama.\n2. Melaksanakan evaluasi formatif (soal pilihan ganda).\n3. Refleksi pembelajaran dan penyampaian materi pertemuan berikutnya.\n4. Menutup dengan doa dan salam.", durasi: "15 Menit" }
  ],
  pertanyaanPemantik: [
    {
